...
def alignments_intervals(in_dir, out_dir, blocks, block_size, interval_size, separator):
...
def main():
    ...
    alignments_intervals(args.input, args.output, args.blocks, args.block_size, args.interval, args.separator)
