"""
    The training submodule contains necessary functions to train a ML4Phylo network
"""
...
from phyloformer.model import AttentionNet
...
def _init_optimizer(
    ...
    """Instanciates the optimizer to train a ML4Phylo model
    ...
    model : AttentionNet
        ML4Phylo model you want to train
    learning_rate : float
...
def _init_scheduler(
    ...
    """Instanciates a learning rate scheduler for ML4Phylo model training
